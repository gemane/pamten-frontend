...
export const COUNTRY_NAMES = {
  ...
  NL:'Netherlands', SE:'Sweden', CH:'Switzerland', NO:'Norway', BE:'Belgium',
  AT:'Austria', DK:'Denmark', FI:'Finland', PL:'Poland', CZ:'Czech Republic',
  PT:'Portugal', IE:'Ireland', IL:'Israel', SA:'Saudi Arabia', AE:'UAE',
  SG:'Singapore', HK:'Hong Kong', TW:'Taiwan', RU:'Russia', ZA:'South Africa',
  NG:'Nigeria', EG:'Egypt', AR:'Argentina', CL:'Chile', CO:'Colombia',
  PH:'Philippines', MY:'Malaysia', TH:'Thailand', ID:'Indonesia', VN:'Vietnam',
  UA:'Ukraine', TR:'Turkey', LU:'Luxembourg', CY:'Cyprus', MT:'Malta',
